...
import { Alert, Modal, StyleSheet, Text, Pressable, View, Image, ScrollView, SafeAreaView, TouchableOpacity,FlatList } from "react-native";
                ...
                <View style={{ flex: 1, justifyContent: "center" }} data={DATA}>
                  ...
                  >
                    ...
                    <View style={{ padding: 10, width: 200 }}>
                      <Text style={styles.input1} onChangeText={(e) => { setBrand(e) }} >{brand}</Text>
